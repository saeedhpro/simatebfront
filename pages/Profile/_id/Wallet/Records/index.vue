        ...
        <div class="p-4 bg-white rounded-lg shadow-md">
          ...
          <div class="mt-5 overflow-x-auto">
            <div class="h-20 flex border-solid border-2 border-gray-901 rounded-t-lg bg-gray-902 minWight ">
              ...
              <div class="w-48 py-5 border-l-2 border-gray-901 text-center">نام صاحب حساب</div>
            ...
            <div v-if="userWallerHistories">
              <div
                ...
                <div class="w-32 py-2 border-l-2 border-gray-901 text-center">{{ i.balance | toPersianCurrency  }}</div>
                <div class="w-32 py-2 border-l-2 border-gray-901 text-center">{{ '' }}</div>
                <div class="w-48 py-2 border-l-2 border-gray-901 text-center">{{ `${i.fname} ${i.lname}` | toPersianNumber }}</div>
                <div class="w-32 py-2 border-l-2 border-gray-901 text-center">{{ i.sheba | toPersianNumber }}</div>
                <div class="w-32 py-2 border-l-2 border-gray-901 text-center">{{ '' | toPersianNumber }}</div>
                <div class="w-32 py-2 border-l-2 border-gray-901 text-center">{{ '' | toPersianNumber }}</div>
...
export default {
  ...
  methods: {
    ...
    getUserWallerHistories(id) {
      this.$store.dispatch('wallet/userWallet/getUserWallerHistories', id)
    },
