<template>
  <div class="p-4 bg-white shadow-md rounded-lg">
    <div class="mb-2 flex border-b border-gray-300">
      <div class="pb-4 text-sm text-black Bold border-b-4 border-blue-902">آخرین ورود بیماران</div>
    </div>
  <div class="mt-6 overflow-x-auto">
    <div class=" flex border-solid border-2 border-gray-901 rounded-t-lg bg-gray-902 minWight ">
      ...
      <div class="w-24 py-3 border-l-2 border-gray-901 text-center">گروه</div>
...
<!--        <img src="/img/1601734331278.jpg" class="w-8 h-8 mx-2 rounded-md" v-else>-->
      ...
      <div class="w-24 py-2 border-l-2 border-gray-901 text-center">{{ i.user_group_name }}</div>
...
export default {
  name: "LastLogin",
  mounted() {
    this.$store.dispatch('admin/user/getLastLogin')
  },
  computed:{
    lastLoginList(){
      return this.$store.getters["admin/user/getLastLogin"]
    }
  }
