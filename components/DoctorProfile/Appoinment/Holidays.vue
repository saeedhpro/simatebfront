  ...
  <div>
    ...
    <div class="overflow-auto">
      <div class="h-12 flex border-solid border-2 border-gray-901 rounded-t-lg bg-gray-902 minWight">
        ...
        <div class="w-80 py-2 border-l-2 border-gray-901 text-center">عنوان</div>
      ...
      <div v-if="holidayList">
        <div class="h-12 flex border-b-2 border-r-2 border-l-2 border-gray-901 minWight table-link"
          ...
          <div class="w-80 py-2 border-l-2 border-gray-901 text-center">{{ i.title }}</div>
          <div class="px-5 py-2 text-center flex justify-end">
      ...
      <!--            <pagination v-if="holidayList && holidayList.data" :limit="10" :data="holidayList.data" @pagination-change-page=""></pagination>-->
    ...
    deleteHoliday({id}) {
      this.$store.dispatch('admin/holiday/deleteHoliday', id)
        .then(res => {
          ...
          this.$store.dispatch('admin/holiday/getHolidays', {
            start_date: this.start_date,
            end_date: this.end_date
          });
        })
